...
import type { Property, PropertyContent, RoomType, BeddingConfiguration, PropertyAmenity, RatePlan } from '../../types/property.types';
...
const RoomsStep: React.FC<{ data: Partial<Property>; onChange: (updates: Partial<Property>) => void }> = () => (
    <div className="form-section">
        <h3 className="form-section-title">Smeštajne Jedinice</h3>
        <p style={{ color: 'var(--text-secondary)' }}>Konfiguracija soba - u razvoju...</p>
    </div>
);
...
const PoliciesStep: React.FC<{ data: Partial<Property>; onChange: (updates: Partial<Property>) => void }> = () => (
    <div className="form-section">
        <h3 className="form-section-title">Pravila i Politike</h3>
        <p style={{ color: 'var(--text-secondary)' }}>House Rules & Cancellation - u razvoju...</p>
    </div>
);
